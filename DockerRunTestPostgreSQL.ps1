Set-Variable -Name "containerName" -Value "postgreSQLTest"
...
#WARNING ! Deletes all unused volumes !!!!!!!!!
docker run --name "$(Get-Variable -Name "containerName" -ValueOnly)" -e POSTGRES_PASSWORD=admin -e POSTGRES_USER=admin -p 5434:5432 -d postgres;